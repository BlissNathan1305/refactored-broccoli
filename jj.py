...
num_wallpapers = 10          # Generate 10 wallpapers
...
for i in range(num_wallpapers):
    ...
    # Convert to Pillow Image and save as 4K JPEG
    ...
    print(f"Wallpaper {i+1} saved as {filename}")

print("All 10 mobile 4K wallpapers generated successfully!")
