...
# ---- Wallpaper Settings ----
width, height = 1920, 1080  # Change to 3840, 2160 for 4K
num_wallpapers = 1           # Number of wallpapers to generate
...
for i in range(num_wallpapers):
    ...
    scale = random.uniform(80, 150)  # Randomize scale
    ...
    filename = f"stunning_wallpaper_{i+1}.jpg"
